...
const WorkPage = () => {
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            {/* Hero Section */}
            <section className="relative h-[55vh] w-full bg-[#1D6BFF] overflow-hidden flex flex-col items-center justify-center pt-24">
                ...
                <motion.div 
                    ...
                    className="absolute top-[35%] right-[15%] z-20"
                >
                    <div className="relative w-32 h-14 flex items-center justify-center">
                        ...
                        {/* Alternative bubble shape for "cloud" look */}
                ...
                <motion.h1 
                    ...
                    className="relative z-10 text-[22vw] md:text-[16vw] text-white font-normal uppercase leading-none select-none tracking-tight"
                ...
                <motion.div 
                    ...
                    className="absolute bottom-12 right-[25%] text-white"
                >
                ...
                <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] transform translate-y-1">
                    <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-[200%] h-[70px] text-white fill-current">
            ...
            {/* Works Listing Grid */}
            <section className="max-w-[1700px] mx-auto px-8 py-32 md:px-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
                    {works.map((work, index) => (
                        ...
                        >
                            ...
                            >
                                <div 
                                    className="relative rounded-[50px] overflow-hidden p-8 md:p-12 mb-6"
                                    style={{ backgroundColor: work.bgColor || (index % 2 === 0 ? '#F9D7E8' : '#7CB1FF') }}
                                >
                                    <div className="relative aspect-[4/3] rounded-[30px] overflow-hidden shadow-2xl transition-transform duration-500 group-hover:scale-[1.02]">
                                        <img 
                                            src={work.imageUrl} 
                                            alt={work.title} 
                                ...
                                <div className="flex justify-between items-end px-4">
                                    <div>
                                        <h3 className="text-3xl md:text-4xl font-semibold uppercase mb-2" style={{ fontFamily: 'var(--font-archivo-black)' }}>
                                            {work.title}
                                        </h3>
                                        <p className="text-gray-500 text-lg font-medium uppercase tracking-wider">
                                            {work.category}
                                        </p>
                                    </div>
