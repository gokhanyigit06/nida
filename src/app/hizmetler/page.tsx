...
const SERVICES = [
  {
    ...
    description:
      'Konseptten final kareye kadar tüm prodüksiyon sürecini yönetiyoruz. Çekim, kurgu, renk düzeltme ve ses tasarımıyla etki bırakan içerikler üretiyoruz.',
  ...
  },
  {
    ...
    description:
      'Platforma özel, akılda kalıcı ve etkileşimi yüksek video içerikler üretiyoruz. Reels, story, tanıtım videosu — markanızın sesini dijitale taşıyoruz.',
...
const ServiceRow = ({ service, index }: { service: typeof SERVICES[0]; index: number }) => {
  ...
  return (
    ...
    >
      {/* Numara */}
      <span
        className="text-xs text-black/30 font-medium pt-1"
      ...
      <div>
        ...
        <p
          className="text-sm text-black/50 leading-relaxed max-w-[380px]"
          style={{ fontFamily: 'var(--font-inter)' }}
        >
          {service.description}
        </p>
        ...
        <div className="site-px pt-12 pb-2">
          <div className="flex items-end justify-between gap-8">
            ...
            <motion.p
              ...
              style={{ fontFamily: 'var(--font-inter)' }}
            >
              Karmaşıklığı ortadan kaldırıyor, markanızın gerçek potansiyelini ortaya çıkaran sade ve güçlü tasarım çözümleri üretiyoruz.
            </motion.p>
          </div>
        </div>
        ...
        >
          <div className="bg-black rounded-2xl px-12 md:px-16 py-16 md:py-20 flex flex-col md:flex-row items-start md:items-center justify-between gap-10">
            ...
            <div className="flex flex-col items-start gap-6 shrink-0">
              <p
                className="text-sm text-white/55 leading-relaxed max-w-[260px]"
                style={{ fontFamily: 'var(--font-inter)' }}
              >
                Karmaşıklığı ortadan kaldıran premium video ve dijital çözümlerimizle markanızı sektörde bir adım öne taşımak için buradayız.
              </p>
              <Link
                href="/contact"
